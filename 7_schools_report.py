...
print('\n\nAll universities that have a graduation rate for Women over 75%:')
print('-' * 64)
#Grad rate for women
...
#I was getting an error at the end of my code even though it finished printing the output
#I used "None" to get rid of it and found that Vanderbilt University also meets the criteria 
#(but wasn't listed on the outcome picture)